...
SLOT="4/17.22.8" # ffmpeg subslot naming: SONAME tuple of {libmbedcrypto.so,libmbedtls.so,libmbedx509.so}
...
PATCHES=(
	"${FILESDIR}/mbedtls-4.0.0-slotted-version-PR9935.patch"
	"${FILESDIR}/mbedtls-4.2.0-fix-symlink-sandbox-vialation.patch"
)
