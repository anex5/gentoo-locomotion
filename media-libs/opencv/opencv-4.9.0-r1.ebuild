...
# hardware
IUSE+=" opencl cuda cudnn video_cards_intel ${CUDA_TARGETS_COMPAT[@]/#/cuda_targets_}"
# video
IUSE+=" avif +ffmpeg gstreamer xine v4l vaapi vulkan gphoto2 ieee1394"
# image
IUSE+=" gdal jasper jpeg jpeg2k openexr png quirc tesseract tiff webp"
# gui
IUSE+=" gtk3 qt5 qt6 opengl vtk wayland"
# parallel
IUSE+=" openmp tbb"
# lapack options
