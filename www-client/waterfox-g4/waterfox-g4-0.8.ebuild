...
IUSE="+clang cpu_flags_arm_neon dbus debug eme-free geckodriver +gmp-autoupdate \
	...
	+system-libvpx system-png +system-webp wayland wifi kde"
...
COMMON_DEPEND="
	!<www-client/waterfox-classic-2021.08-r1
	>=dev-libs/nss-3.68
	>=dev-libs/nspr-4.32
	dev-libs/atk
	dev-libs/expat
...
MOZ_LANGS+=(
	ach an az bn bs ca-valencia eo es-CL es-MX fa ff gn gu-IN hi-IN hy-AM
	ia km kn lij mk mr my ne-NP oc sco si son szl ta te tl trs ur xh
)
...
src_prepare() {
	...
	# unfuck URLbar
	eapply "${FILESDIR}/${PN}.0.3-URLbar_unfuck.patch"
...
src_configure() {
	...
	mozconfig_add_options_ac 'Waterfox' --with-app-basename=${PN/-g4}
	mozconfig_add_options_ac 'Waterfox' --with-branding=browser/branding/waterfox
...
src_compile() {
	...
	# Inspired by
	# https://build.opensuse.org/package/view_file/home:hawkeye116477:waterfox/waterfox-g3-appimage/waterfox-g3.spec?expand=0
...
src_install() {
	...
	# Install icons
	local icon_srcdir="${S}/browser/branding/waterfox"
...
pkg_postinst() {
	...
	elog "Cloudflare browser checks are broken with Waterfox fingerprinting measures."
