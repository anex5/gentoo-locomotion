...
src_unpack(){
	...
	wget "https://chromium.googlesource.com/android_tools/+/HEAD/sdk/platforms/android-28/" || die
	mv "android.jar" "${S}/third_party/android_sdk/public/platforms/android-28/android.jar" || die
