...
src_unpack(){
	...
	git-r3_checkout "https://chromium.googlesource.com/chromium/llvm-project/libcxxabi.git" "buildtools/third_party/libc++abi/trunk"

	git-r3_fetch "https://chromium.googlesource.com/external/llvm.org/libunwind.git" "69d9b84cca8354117b9fe9705a4430d789ee599b"
	git-r3_checkout "https://chromium.googlesource.com/external/llvm.org/libunwind.git" "buildtools/third_party/libunwind/trunk"

	git-r3_fetch "https://chromium.googlesource.com/media_router.git" "29324b698ccd8920bc81c71d42dadc6310f0ad0f"
	git-r3_checkout "https://chromium.googlesource.com/media_router.git" "chrome/browser/resources/media_router/extension/src"

	git-r3_fetch "https://chromium.googlesource.com/chromium/canvas_bench.git" "a7b40ea5ae0239517d78845a5fc9b12976bfc732"
	git-r3_checkout "https://chromium.googlesource.com/chromium/canvas_bench.git" "chrome/test/data/perf/canvas_bench"

	git-r3_fetch "https://chromium.googlesource.com/chromium/frame_rate/content.git" "c10272c88463efeef6bb19c9ec07c42bc8fe22b9"
	git-r3_checkout "https://chromium.googlesource.com/chromium/frame_rate/content.git" "chrome/test/data/perf/frame_rate/content"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/toji/webvr.info.git" "chrome/test/data/xr/webvr_info"

	git-r3_fetch "https://chromium.googlesource.com/chromium/cdm.git" "817c8005a57ea3ca417f767b3b3679601329afd8"
	git-r3_checkout "https://chromium.googlesource.com/chromium/cdm.git" "media/cdm/api"
	...
	git-r3_checkout "https://chromium.googlesource.com/native_client/src/native_client.git" "native_client"

	git-r3_fetch "https://quiche.googlesource.com/quiche.git" "b417d60c04d847ac676aa4492c79a17fadca509e"
	git-r3_checkout "https://quiche.googlesource.com/quiche.git" "net/third_party/quiche/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/KhronosGroup/SPIRV-Tools.git" "third_party/SPIRV-Tools/src"
	...
	git-r3_fetch "https://chromium.googlesource.com/external/deqp" "e773f33c5a0fa5f8f8147f3ee77d540d1cf974d0"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/glmark2/glmark2" "third_party/angle/third_party/glmark2/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/Tencent/rapidjson" "third_party/angle/third_party/rapidjson/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/KhronosGroup/Vulkan-Headers" "third_party/angle/third_party/vulkan-headers/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/KhronosGroup/Vulkan-Loader" "third_party/angle/third_party/vulkan-loader/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/KhronosGroup/Vulkan-Tools" "third_party/angle/third_party/vulkan-tools/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/KhronosGroup/Vulkan-ValidationLayers" "third_party/angle/third_party/vulkan-validation-layers/src"

	git-r3_fetch "https://boringssl.googlesource.com/boringssl.git" "2e0d354690064c90ee245c715b92e2bb32492571"
	git-r3_checkout "https://boringssl.googlesource.com/boringssl.git" "third_party/boringssl/src"

	git-r3_fetch "https://chromium.googlesource.com/breakpad/breakpad.git" "1fc9cc0d0e1dfafb8d29dba8d01f09587d870026"
	git-r3_checkout "https://chromium.googlesource.com/breakpad/breakpad.git" "third_party/breakpad/breakpad"

	git-r3_fetch "https://chromium.googlesource.com/catapult.git" "fa2fd31ebd189625ee47aacbf75aa7c217169c01"
	git-r3_checkout "https://chromium.googlesource.com/catapult.git" "third_party/catapult"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/google/cld_3.git" "third_party/cld_3/src"

	git-r3_fetch "https://chromium.googlesource.com/external/colorama.git" "799604a1041e9b3bc5d2789ecbd7e8db2e18e6b8"
	git-r3_checkout "https://chromium.googlesource.com/external/colorama.git" "third_party/colorama/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/google/crc32c.git" "third_party/crc32c/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/chromiumos/platform2/system_api.git" "third_party/cros_system_api"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/videolan/dav1d.git" "third_party/dav1d/libdav1d"

	git-r3_fetch "https://dawn.googlesource.com/dawn.git" "26d3cf08c209c662a6e2298c301272e2eb8246e4"
	git-r3_checkout "https://dawn.googlesource.com/dawn.git" "third_party/dawn"

	git-r3_fetch "https://chromium.googlesource.com/chromium/tools/depot_tools.git" "bad01ad3adaaa017b780f020d85a1e3b34f89c98"
	git-r3_checkout "https://chromium.googlesource.com/chromium/tools/depot_tools.git" "third_party/depot_tools"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/ChromeDevTools/devtools-node-modules" "third_party/devtools-node-modules"

	git-r3_fetch "https://chromium.googlesource.com/chromium/dom-distiller/dist.git" "3093c3e238768ab27ff756bd7563ccbb12129d9f"
	git-r3_checkout "https://chromium.googlesource.com/chromium/dom-distiller/dist.git" "third_party/dom_distiller_js/dist"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/googlei18n/emoji-segmenter.git" "third_party/emoji-segmenter/src"

	#git-r3_fetch "https://chromium.googlesource.com/chromium/third_party/ffmpeg.git" "e1e3cc4d2ec19c4e1859e487e8b7529cb69d91d8"
	#git-r3_checkout "https://chromium.googlesource.com/chromium/third_party/ffmpeg.git" "third_party/ffmpeg"

	git-r3_fetch "https://chromium.googlesource.com/chromium/deps/flac.git" "af862024c8c8fa0ae07ced05e89013d881b00596"
	git-r3_checkout "https://chromium.googlesource.com/chromium/deps/flac.git" "third_party/flac"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/google/flatbuffers.git" "third_party/flatbuffers/src"

	git-r3_fetch "https://chromium.googlesource.com/external/fontconfig.git" "ba206df9b9a7ca300265f650842c1459ff7c634a"
	git-r3_checkout "https://chromium.googlesource.com/external/fontconfig.git" "third_party/fontconfig/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/chromium/src/third_party/freetype2.git" "third_party/freetype/src"

	git-r3_fetch "https://chromium.googlesource.com/chromiumos/platform/gestures.git" "74f55100df966280d305d5d5ada824605f875839"
	git-r3_checkout "https://chromium.googlesource.com/chromiumos/platform/gestures.git" "third_party/gestures/gestures"

	git-r3_fetch "https://chromium.googlesource.com/external/github.com/glfw/glfw.git" "2de2589f910b1a85905f425be4d32f33cec092df"
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/glfw/glfw.git" "third_party/glfw/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/KhronosGroup/glslang.git" "third_party/glslang/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/google/googletest.git" "third_party/googletest/src"

	git-r3_fetch "https://chromium.googlesource.com/external/github.com/grpc/grpc.git" "b245ad4ae810ed6bc13378421edfd3986a8ffac3"
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/grpc/grpc.git" "third_party/grpc/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/harfbuzz/harfbuzz.git" "third_party/harfbuzz-ng/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/chromium/deps/hunspell_dictionaries.git" "third_party/hunspell_dictionaries"

	git-r3_fetch "https://chromium.googlesource.com/chromium/deps/icu.git" "64e5d7d43a1ff205e3787ab6150bbc1a1837332b"
	git-r3_checkout "https://chromium.googlesource.com/chromium/deps/icu.git" "third_party/icu"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/open-source-parsers/jsoncpp.git" "third_party/jsoncpp/source"

	git-r3_fetch "https://chromium.googlesource.com/external/leveldb.git" "4bd052d7e8b0469b2b87664388e2a99cb212ecdb"
	git-r3_checkout "https://chromium.googlesource.com/external/leveldb.git" "third_party/leveldatabase/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/chromium/llvm-project/compiler-rt/lib/fuzzer.git" "third_party/libFuzzer/src"

	git-r3_fetch "https://chromium.googlesource.com/external/libaddressinput.git" "56c60affb5de83c10ebf5f11d9adcdd70648ab71"
	git-r3_checkout "https://chromium.googlesource.com/external/libaddressinput.git" "third_party/libaddressinput/src"

	git-r3_fetch "https://aomedia.googlesource.com/aom.git" "625cded0550bb79efd10d98a9809a7ccd72a8f60"
	git-r3_checkout "https://aomedia.googlesource.com/aom.git" "third_party/libaom/source/libaom"

	git-r3_fetch "https://chromium.googlesource.com/chromiumos/third_party/libdrm.git" "0061b1f244574e615c415479725046ab2951f09a"
	git-r3_checkout "https://chromium.googlesource.com/chromiumos/third_party/libdrm.git" "third_party/libdrm/src"

	git-r3_fetch "https://chromium.googlesource.com/chromiumos/platform/libevdev.git" "9f7a1961eb4726211e18abd147d5a11a4ea86744"
	git-r3_checkout "https://chromium.googlesource.com/chromiumos/platform/libevdev.git" "third_party/libevdev/src"

	git-r3_fetch "https://chromium.googlesource.com/chromium/deps/libjpeg_turbo.git" "2de84a43e683c2c3c8ff4922da16b9053f024144"
	git-r3_checkout "https://chromium.googlesource.com/chromium/deps/libjpeg_turbo.git" "third_party/libjpeg_turbo"

	git-r3_fetch "https://chromium.googlesource.com/external/liblouis-github.git" "97ce1c67fccbd3668291b7e63c06161c095d49f2"
	git-r3_checkout "https://chromium.googlesource.com/external/liblouis-github.git" "third_party/liblouis/src"

	git-r3_fetch "https://chromium.googlesource.com/external/libphonenumber.git" "a4da30df63a097d67e3c429ead6790ad91d36cf4"
	git-r3_checkout "https://chromium.googlesource.com/external/libphonenumber.git" "third_party/libphonenumber/dist"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/google/libprotobuf-mutator.git" "third_party/libprotobuf-mutator/src"

	git-r3_fetch "https://chromium.googlesource.com/chromium/deps/libsrtp.git" "650611720ecc23e0e6b32b0e3100f8b4df91696c"
	git-r3_checkout "https://chromium.googlesource.com/chromium/deps/libsrtp.git" "third_party/libsrtp"
	...
	git-r3_checkout "https://chromium.googlesource.com/aosp/platform/system/core/libsync.git" "third_party/libsync/src"

	git-r3_fetch "https://chromium.googlesource.com/webm/libvpx.git" "0308a9a132612006056f9920c069a1942e49c26c"
	git-r3_checkout "https://chromium.googlesource.com/webm/libvpx.git" "third_party/libvpx/source/libvpx"

	git-r3_fetch "https://chromium.googlesource.com/webm/libwebm.git" "51ca718c3adf0ddedacd7df25fe45f67dc5a9ce1"
	git-r3_checkout "https://chromium.googlesource.com/webm/libwebm.git" "third_party/libwebm/source"

	git-r3_fetch "https://chromium.googlesource.com/libyuv/libyuv.git" "b36c86fdfe746d7be904c3a565b047b24d58087e"
	git-r3_checkout "https://chromium.googlesource.com/libyuv/libyuv.git" "third_party/libyuv"

	git-r3_fetch "https://chromium.googlesource.com/linux-syscall-support.git" "e6527b0cd469e3ff5764785dadcb39bf7d787154"
	git-r3_checkout "https://chromium.googlesource.com/linux-syscall-support.git" "third_party/lss"

	git-r3_fetch "https://chromium.googlesource.com/chromiumos/platform/minigbm.git" "4fe3038be586d5db8e44e452f5ed6a93c8ccf50a"
	git-r3_checkout "https://chromium.googlesource.com/chromiumos/platform/minigbm.git" "third_party/minigbm/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/nmoinvaz/minizip" "third_party/minizip/src"

	git-r3_fetch "https://chromium.googlesource.com/chromium/deps/nasm.git" "c8b248039ec1f75a7c5733bbe76d7fa416ce097a"
	git-r3_checkout "https://chromium.googlesource.com/chromium/deps/nasm.git" "third_party/nasm"

	git-r3_fetch "https://chromium.googlesource.com/external/github.com/cisco/openh264" "6f26bce0b1c4e8ce0e13332f7c0083788def5fdf"
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/cisco/openh264" "third_party/openh264/src"
	...
	git-r3_checkout "https://pdfium.googlesource.com/pdfium.git" "third_party/pdfium"

	git-r3_fetch "https://android.googlesource.com/platform/external/perfetto.git" "7f727d4068ec466c3b1f3ba5f178fe2f58f1d1d7"
	git-r3_checkout "https://android.googlesource.com/platform/external/perfetto.git" "third_party/perfetto"
	...
	git-r3_checkout "https://chromium.googlesource.com/chromiumos/third_party/pyelftools.git" "third_party/pyelftools"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/google/pywebsocket.git" "third_party/pywebsocket/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/google/quic-trace.git" "third_party/quic_trace/src"

	git-r3_fetch "https://chromium.googlesource.com/external/github.com/google/re2.git" "a98fad02c421896bc75d97f49ccd245cdce7dd55"
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/google/re2.git" "third_party/re2/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/googlei18n/sfntly.git" "third_party/sfntly/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/google/shaderc.git" "third_party/shaderc/src"

	git-r3_fetch "https://skia.googlesource.com/skia.git" "refs/heads/chrome/m76"
	git-r3_checkout "https://skia.googlesource.com/skia.git" "third_party/skia"

	git-r3_fetch "https://chromium.googlesource.com/external/smhasher.git" "e87738e57558e0ec472b2fc3a643b838e5b6e88f"
	git-r3_checkout "https://chromium.googlesource.com/external/smhasher.git" "third_party/smhasher/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/google/snappy.git" "third_party/snappy/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/KhronosGroup/SPIRV-Cross.git" "third_party/spirv-cross/spirv-cross"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/KhronosGroup/SPIRV-Headers.git" "third_party/spirv-headers/src"

	git-r3_fetch "https://swiftshader.googlesource.com/SwiftShader.git" "c0d7ee45d45f22772ceca9e961c1ab4cfc9322d9"
	git-r3_checkout "https://swiftshader.googlesource.com/SwiftShader.git" "third_party/swiftshader"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/sctplab/usrsctp" "third_party/usrsctp/usrsctplib"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/anongit.freedesktop.org/git/wayland/wayland-protocols.git" "third_party/wayland-protocols/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/anongit.freedesktop.org/git/wayland/wayland.git" "third_party/wayland/src"

	git-r3_fetch "https://chromium.googlesource.com/external/github.com/01org/wds" "ac3d8210d95f3000bf5c8e16a79dbbbf22d554a5"
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/01org/wds" "third_party/wds/src"
	...
	git-r3_checkout "https://chromium.googlesource.com/external/github.com/SeleniumHQ/selenium/py.git" "third_party/webdriver/pylib"

	git-r3_fetch "https://chromium.googlesource.com/external/khronosgroup/webgl.git" "6f0b34abee8dba611c253738d955c59f703c147a"
	git-r3_checkout "https://chromium.googlesource.com/external/khronosgroup/webgl.git" "third_party/webgl/src"

	git-r3_fetch "https://webrtc.googlesource.com/src.git" "refs/branch-heads/m76"
	git-r3_checkout "https://webrtc.googlesource.com/src.git" "third_party/webrtc"

	git-r3_fetch "https://chromium.googlesource.com/chromium/deps/xdg-utils.git" "d80274d5869b17b8c9067a1022e4416ee7ed5e0d"
	git-r3_checkout "https://chromium.googlesource.com/chromium/deps/xdg-utils.git" "third_party/xdg-utils"
	...
	git-r3_checkout "https://chromium.googlesource.com/v8/v8.git" "v8"
