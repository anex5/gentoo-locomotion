...
PATCHES=(
	# Gentoo patches
	"${FILESDIR}/chromium-$(ver_cut 1-1)/chromium-compiler-r10.patch"
	...
	"${FILESDIR}/chromium-$(ver_cut 1-1)/chromium-80-unbundle-libxml.patch"
	"${FILESDIR}/chromium-$(ver_cut 1-1)/chromium-80-include.patch"
...
src_prepare() {
	...
	#use "perfetto" || eapply "${p}/chromium-disable-perfetto-r1.patch"
