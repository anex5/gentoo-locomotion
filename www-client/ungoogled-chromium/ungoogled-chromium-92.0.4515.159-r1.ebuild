...
UGC_COMMIT_ID="0133689f8837e459e2ee92f1eb5961fe9ca9c43f"
...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="atk alsa cfi clang convert-dict cups custom-cflags chromedriver dbus debug gold gtk \
...
src_prepare() {
	...
	eapply "${p}/0001-DCScan-Fix-builds-with-system-sysroots.patch"
	...
	eapply "${p}/fix-harfbuzz-supp-size-error.patch"
	eapply "${p}/limit-number-of-LTO-jobs.patch"
