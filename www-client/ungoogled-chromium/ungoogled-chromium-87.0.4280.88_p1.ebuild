...
PATCHES=(
	...
	"${FILESDIR}/chromium-$(ver_cut 1-1)/chromium-87-ozone-deps.patch"
    "${FILESDIR}/chromium-$(ver_cut 1-1)/chromium-87-webcodecs-deps.patch"
    "${FILESDIR}/chromium-$(ver_cut 1-1)/chromium-87-v8-icu68.patch"
	"${FILESDIR}/chromium-$(ver_cut 1-1)/chromium-87-icu68.patch"
	...
	# Personal patches
	"${FILESDIR}/chromium-$(ver_cut 1-1)/chromium-fix-nosafebrowsing-build-r2.patch"
	"${FILESDIR}/chromium-$(ver_cut 1-1)/chromium-optional-dbus-r10.patch"
	"${FILESDIR}/chromium-$(ver_cut 1-1)/chromium-optional-atk-r2.patch"
)
...
src_prepare() {
	...
	use vdpau && eapply "${p}/vdpau-support-r2.patch"
