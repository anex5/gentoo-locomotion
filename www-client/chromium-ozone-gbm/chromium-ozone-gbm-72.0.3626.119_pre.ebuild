...
UGC_PV="a80839c418de8843dfcd6c13a557f12d26a0a17a"
...
IUSE="
	cfi component-build closure-compile cups custom-cflags +dbus gold jumbo-build kerberos libcxx
	...
	wayland libvpx gtk xkbcommon v4l2 v4lplugin +clang clang_tidy 
	swiftshader udev debug 
"
...
src_configure() {
	...
	set -- gn gen --args="${myconf_gn[*]} ${EXTRA_GN} target_os=\"chromeos\"" out/Release
	echo "$@"
	"$@" || die	
}
...
src_compile() {
	...
	eninja -C out/Release content_shell
	#use suid && eninja -C out/Release chrome_sandbox

	pax-mark m out/Release/content_shell
}
...
src_install() {
	...
	doexe out/Release/content_shell
