...
IUSE="${IUSE_SERVERS} debug eglstream elogind ipv6 libressl libglvnd minimal selinux +suid systemd +udev unwind xcsecurity"
...
pkg_setup() {
	...
	XORG_CONFIGURE_OPTIONS=(
		...
		--with-sha1=libcrypto
		$(usex eglstream '--enable-xwayland-eglstream' '--disable-xwayland-eglstream')
	)
}
